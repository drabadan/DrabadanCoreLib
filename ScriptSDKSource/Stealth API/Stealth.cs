...
namespace StealthAPI
{
    public class Stealth : IDisposable
    {
        ...
        //private readonly Dictionary<string, int> _Skill = new Dictionary<string, int>();
        ...
        {
           return _client.SendPacket<int>(PacketType.SCGetSkillID, skillName);
        }
        #endregion
        ...
        public bool UseSkill(Skill skill)
        {
            ...
            _client.SendPacket(PacketType.SCUseSkill, skill.Id);
            return true;
        }
        ...
        #region Drabadan edited for compiling
        ...
        public readonly Skill StealthSkill = new Skill() { Value = "Stealth" };
        ...
        public bool UseSkill(SkillName ske)
        {
            ...
            switch (ske)
            {
                case SkillName.Alchemy:
                    return UseSkill(Alchemy);
                case SkillName.Anatomy:
                    return UseSkill(Anatomy);
                case SkillName.AnimalLore:
                    return UseSkill(AnimalLore);
                case SkillName.AnimalTaming:
                    return UseSkill(AnimalTaming);
                case SkillName.Archery:
                    return UseSkill(Archery);
                case SkillName.ArmsLore:
                    return UseSkill(Armslore);
                case SkillName.Begging:
                    return UseSkill(Begging);
                case SkillName.Blacksmith:
                    return UseSkill(Blacksmithy);
                case SkillName.Bushido:
                    return UseSkill(Bushido);
                case SkillName.Camping:
                    return UseSkill(Camping);
                case SkillName.Carpentry:
                    return UseSkill(Carpentry);
                case SkillName.Cartography:
                    return UseSkill(Cartography);
                case SkillName.Chivalry:
                    return UseSkill(Chivalry);
                case SkillName.Cooking:
                    return UseSkill(Cooking);
                case SkillName.DetectHidden:
                    return UseSkill(DetectHidden);
                case SkillName.Discordance:
                    return UseSkill(Discordance);
                case SkillName.EvalInt:
                    return UseSkill(EvaluateIntelligence);
                case SkillName.Fencing:
                    return UseSkill(Fencing);
                case SkillName.Fishing:
                    return UseSkill(Fishing);
                case SkillName.Fletching:
                    return UseSkill(Bowcraft);
                case SkillName.Focus:
                    return UseSkill(Focus);
                case SkillName.Forensics:
                    return UseSkill(Forensic);
                case SkillName.Healing:
                    return UseSkill(Healing);
                case SkillName.Herding:
                    return UseSkill(Herding);
                case SkillName.Hiding:
                    return UseSkill(Hiding);
                case SkillName.Imbuing:
                    return UseSkill(Imbuing);
                case SkillName.Inscribe:
                    return UseSkill(Inscription);
                case SkillName.ItemID:
                    return UseSkill(ItemIdentification);
                case SkillName.Lockpicking:
                    return UseSkill(Lockpicking);
                case SkillName.Lumberjacking:
                    return UseSkill(Lumberjacking);
                case SkillName.Macing:
                    return UseSkill(MaceFighting);
                case SkillName.Magery:
                    return UseSkill(Magery);
                case SkillName.MagicResist:
                    return UseSkill(ResistingSpells);
                case SkillName.Meditation:
                    return UseSkill(Meditation);
                case SkillName.Mining:
                    return UseSkill(Mining);
                case SkillName.Musicianship:
                    return UseSkill(Musicianship);
                case SkillName.Mysticism:
                    return UseSkill(Mysticism);
                case SkillName.Necromancy:
                    return UseSkill(Necromancy);
                case SkillName.Ninjitsu:
                    return UseSkill(Ninjitsu);
                case SkillName.RemoveTrap:
                    return UseSkill(RemoveTrap);
                case SkillName.Stealth:
                    return UseSkill(StealthSkill);
                case SkillName.Snooping:
                    return UseSkill(Snooping);
                case SkillName.Spellweaving:
                    return UseSkill(Spellweaving);
                case SkillName.SpiritSpeak:
                    return UseSkill(SpiritSpeak);
                case SkillName.Stealing:
                    return UseSkill(Stealing);
                case SkillName.Swords:
                    return UseSkill(Swordsmanship);
                case SkillName.Tactics:
                    return UseSkill(Tactics);
                case SkillName.Tailoring:
                    return UseSkill(Tailoring);
                case SkillName.TasteID:
                    return UseSkill(TasteIdentification);
                case SkillName.Throwing:
                    return UseSkill(Throwing);
                case SkillName.Tinkering:
                    return UseSkill(Tinkering);
                case SkillName.Tracking:
                    return UseSkill(Tracking);
                case SkillName.Veterinary:
                    return UseSkill(Veterinary);
                case SkillName.Wrestling:
                    return UseSkill(Wrestling);
            }
        ...
        public void ChangeSkillLockState(Skill skill, byte Skilltate)
        {
            int skillId;
            if (!GetSkillID(skill, out skillId))
                AddToSystemJournal("Error: " + MethodBase.GetCurrentMethod() + " [Unknown skill name]");
            else
                _client.SendPacket(PacketType.SCChangeSkillLockState, skillId, Skilltate);
        }

        public void ChangeSkillLockState(SkillName ske, byte Skilltate)
        {
            Skill sk = new Skill();
            ...
            {
                case SkillName.Alchemy:
                    ChangeSkillLockState(Alchemy, Skilltate);
                    break;
                case SkillName.Anatomy:
                    ChangeSkillLockState(Anatomy, Skilltate);
                    break;
                case SkillName.AnimalLore:
                    ChangeSkillLockState(AnimalLore, Skilltate);
                    break;
                case SkillName.AnimalTaming:
                    ChangeSkillLockState(AnimalTaming, Skilltate);
                    break;
                case SkillName.Archery:
                    ChangeSkillLockState(Archery, Skilltate);
                    break;
                case SkillName.ArmsLore:
                    ChangeSkillLockState(Armslore, Skilltate);
                    break;
                case SkillName.Begging:
                    ChangeSkillLockState(Begging, Skilltate);
                    break;
                case SkillName.Blacksmith:
                    ChangeSkillLockState(Blacksmithy, Skilltate);
                    break;
                case SkillName.Bushido:
                    ChangeSkillLockState(Bushido, Skilltate);
                    break;
                case SkillName.Camping:
                    ChangeSkillLockState(Camping, Skilltate);
                    break;
                case SkillName.Carpentry:
                    ChangeSkillLockState(Carpentry, Skilltate);
                    break;
                case SkillName.Cartography:
                    ChangeSkillLockState(Cartography, Skilltate);
                    break;
                case SkillName.Chivalry:
                    ChangeSkillLockState(Chivalry, Skilltate);
                    break;
                case SkillName.Cooking:
                    ChangeSkillLockState(Cooking, Skilltate);
                    break;
                case SkillName.DetectHidden:
                    ChangeSkillLockState(DetectHidden, Skilltate);
                    break;
                case SkillName.Discordance:
                    ChangeSkillLockState(Discordance, Skilltate);
                    break;
                case SkillName.EvalInt:
                    ChangeSkillLockState(EvaluateIntelligence, Skilltate);
                    break;
                case SkillName.Fencing:
                    ChangeSkillLockState(Fencing, Skilltate);
                    break;
                case SkillName.Fishing:
                    ChangeSkillLockState(Fishing, Skilltate);
                    break;
                case SkillName.Fletching:
                    ChangeSkillLockState(Bowcraft, Skilltate);
                    break;
                case SkillName.Focus:
                    ChangeSkillLockState(Focus, Skilltate);
                    break;
                case SkillName.Forensics:
                    ChangeSkillLockState(Forensic, Skilltate);
                    break;
                case SkillName.Healing:
                    ChangeSkillLockState(Healing, Skilltate);
                    break;
                case SkillName.Herding:
                    ChangeSkillLockState(Herding, Skilltate);
                    break;
                case SkillName.Hiding:
                    ChangeSkillLockState(Hiding, Skilltate);
                    break;
                case SkillName.Imbuing:
                    ChangeSkillLockState(Imbuing, Skilltate);
                    break;
                case SkillName.Inscribe:
                    ChangeSkillLockState(Inscription, Skilltate);
                    break;
                case SkillName.ItemID:
                    ChangeSkillLockState(ItemIdentification, Skilltate);
                    break;
                case SkillName.Lockpicking:
                    ChangeSkillLockState(Lockpicking, Skilltate);
                    break;
                case SkillName.Lumberjacking:
                    ChangeSkillLockState(Lumberjacking, Skilltate);
                    break;
                case SkillName.Macing:
                    ChangeSkillLockState(MaceFighting, Skilltate);
                    break;
                case SkillName.Magery:
                    ChangeSkillLockState(Magery, Skilltate);
                    break;
                case SkillName.MagicResist:
                    ChangeSkillLockState(ResistingSpells, Skilltate);
                    break;
                case SkillName.Meditation:
                    ChangeSkillLockState(Meditation, Skilltate);
                    break;
                case SkillName.Mining:
                    ChangeSkillLockState(Mining, Skilltate);
                    break;
                case SkillName.Musicianship:
                    ChangeSkillLockState(Musicianship, Skilltate);
                    break;
                case SkillName.Mysticism:
                    ChangeSkillLockState(Mysticism, Skilltate);
                    break;
                case SkillName.Necromancy:
                    ChangeSkillLockState(Necromancy, Skilltate);
                    break;
                case SkillName.Ninjitsu:
                    ChangeSkillLockState(Ninjitsu, Skilltate);
                    break;
                case SkillName.RemoveTrap:
                    ChangeSkillLockState(RemoveTrap, Skilltate);
                    break;
                case SkillName.Stealth:
                    ChangeSkillLockState(StealthSkill, Skilltate);
                    break;
                case SkillName.Snooping:
                    ChangeSkillLockState(Snooping, Skilltate);
                    break;
                case SkillName.Spellweaving:
                    ChangeSkillLockState(Spellweaving, Skilltate);
                    break;
                case SkillName.SpiritSpeak:
                    ChangeSkillLockState(SpiritSpeak, Skilltate);
                    break;
                case SkillName.Stealing:
                    ChangeSkillLockState(Stealing, Skilltate);
                    break;
                case SkillName.Swords:
                    ChangeSkillLockState(Swordsmanship, Skilltate);
                    break;
                case SkillName.Tactics:
                    ChangeSkillLockState(Tactics, Skilltate);
                    break;
                case SkillName.Tailoring:
                    ChangeSkillLockState(Tailoring, Skilltate);
                    break;
                case SkillName.TasteID:
                    ChangeSkillLockState(TasteIdentification, Skilltate);
                    break;
                case SkillName.Throwing:
                    ChangeSkillLockState(Throwing, Skilltate);
                    break;
                case SkillName.Tinkering:
                    ChangeSkillLockState(Tinkering, Skilltate);
                    break;
                case SkillName.Tracking:
                    ChangeSkillLockState(Tracking, Skilltate);
                    break;
                case SkillName.Veterinary:
                    ChangeSkillLockState(Veterinary, Skilltate);
                    break;
                case SkillName.Wrestling:
                    ChangeSkillLockState(Wrestling, Skilltate);
                    break;
            }
        }
        #endregion
        ...
        public double GetSkillCap(SkillName ske)
        {
            ...
            {
                case SkillName.Alchemy:
                    return GetSkillCap(Alchemy);
                case SkillName.Anatomy:
                    return GetSkillCap(Anatomy);
                case SkillName.AnimalLore:
                    return GetSkillCap(AnimalLore);
                case SkillName.AnimalTaming:
                    return GetSkillCap(AnimalTaming);
                case SkillName.Archery:
                    return GetSkillCap(Archery);
                case SkillName.ArmsLore:
                    return GetSkillCap(Armslore);
                case SkillName.Begging:
                    return GetSkillCap(Begging);
                case SkillName.Blacksmith:
                    return GetSkillCap(Blacksmithy);
                case SkillName.Bushido:
                    return GetSkillCap(Bushido);
                case SkillName.Camping:
                    return GetSkillCap(Camping);
                case SkillName.Carpentry:
                    return GetSkillCap(Carpentry);
                case SkillName.Cartography:
                    return GetSkillCap(Cartography);
                case SkillName.Chivalry:
                    return GetSkillCap(Chivalry);
                case SkillName.Cooking:
                    return GetSkillCap(Cooking);
                case SkillName.DetectHidden:
                    return GetSkillCap(DetectHidden);
                case SkillName.Discordance:
                    return GetSkillCap(Discordance);
                case SkillName.EvalInt:
                    return GetSkillCap(EvaluateIntelligence);
                case SkillName.Fencing:
                    return GetSkillCap(Fencing);
                case SkillName.Fishing:
                    return GetSkillCap(Fishing);
                case SkillName.Fletching:
                    return GetSkillCap(Bowcraft);
                case SkillName.Focus:
                    return GetSkillCap(Focus);
                case SkillName.Forensics:
                    return GetSkillCap(Forensic);
                case SkillName.Healing:
                    return GetSkillCap(Healing);
                case SkillName.Herding:
                    return GetSkillCap(Herding);
                case SkillName.Hiding:
                    return GetSkillCap(Hiding);
                case SkillName.Imbuing:
                    return GetSkillCap(Imbuing);
                case SkillName.Inscribe:
                    return GetSkillCap(Inscription);
                case SkillName.ItemID:
                    return GetSkillCap(ItemIdentification);
                case SkillName.Lockpicking:
                    return GetSkillCap(Lockpicking);
                case SkillName.Lumberjacking:
                    return GetSkillCap(Lumberjacking);
                case SkillName.Macing:
                    return GetSkillCap(MaceFighting);
                case SkillName.Magery:
                    return GetSkillCap(Magery);
                case SkillName.MagicResist:
                    return GetSkillCap(ResistingSpells);
                case SkillName.Meditation:
                    return GetSkillCap(Meditation);
                case SkillName.Mining:
                    return GetSkillCap(Mining);
                case SkillName.Musicianship:
                    return GetSkillCap(Musicianship);
                case SkillName.Mysticism:
                    return GetSkillCap(Mysticism);
                case SkillName.Necromancy:
                    return GetSkillCap(Necromancy);
                case SkillName.Ninjitsu:
                    return GetSkillCap(Ninjitsu);
                case SkillName.RemoveTrap:
                    return GetSkillCap(RemoveTrap);
                case SkillName.Stealth:
                    return GetSkillCap(StealthSkill);
                case SkillName.Snooping:
                    return GetSkillCap(Snooping);
                case SkillName.Spellweaving:
                    return GetSkillCap(Spellweaving);
                case SkillName.SpiritSpeak:
                    return GetSkillCap(SpiritSpeak);
                case SkillName.Stealing:
                    return GetSkillCap(Stealing);
                case SkillName.Swords:
                    return GetSkillCap(Swordsmanship);
                case SkillName.Tactics:
                    return GetSkillCap(Tactics);
                case SkillName.Tailoring:
                    return GetSkillCap(Tailoring);
                case SkillName.TasteID:
                    return GetSkillCap(TasteIdentification);
                case SkillName.Throwing:
                    return GetSkillCap(Throwing);
                case SkillName.Tinkering:
                    return GetSkillCap(Tinkering);
                case SkillName.Tracking:
                    return GetSkillCap(Tracking);
                case SkillName.Veterinary:
                    return GetSkillCap(Veterinary);
                case SkillName.Wrestling:
                    return GetSkillCap(Wrestling);
            }
            return 0.0;
        }
        ...
        public double GetSkillValue(SkillName ske)
        {
            ...
            {
                case SkillName.Alchemy:
                    return GetSkillValue(Alchemy);
                case SkillName.Anatomy:
                    return GetSkillValue(Anatomy);
                case SkillName.AnimalLore:
                    return GetSkillValue(AnimalLore);
                case SkillName.AnimalTaming:
                    return GetSkillValue(AnimalTaming);
                case SkillName.Archery:
                    return GetSkillValue(Archery);
                case SkillName.ArmsLore:
                    return GetSkillValue(Armslore);
                case SkillName.Begging:
                    return GetSkillValue(Begging);
                case SkillName.Blacksmith:
                    return GetSkillValue(Blacksmithy);
                case SkillName.Bushido:
                    return GetSkillValue(Bushido);
                case SkillName.Camping:
                    return GetSkillValue(Camping);
                case SkillName.Carpentry:
                    return GetSkillValue(Carpentry);
                case SkillName.Cartography:
                    return GetSkillValue(Cartography);
                case SkillName.Chivalry:
                    return GetSkillValue(Chivalry);
                case SkillName.Cooking:
                    return GetSkillValue(Cooking);
                case SkillName.DetectHidden:
                    return GetSkillValue(DetectHidden);
                case SkillName.Discordance:
                    return GetSkillValue(Discordance);
                case SkillName.EvalInt:
                    return GetSkillValue(EvaluateIntelligence);
                case SkillName.Fencing:
                    return GetSkillValue(Fencing);
                case SkillName.Fishing:
                    return GetSkillValue(Fishing);
                case SkillName.Fletching:
                    return GetSkillValue(Bowcraft);
                case SkillName.Focus:
                    return GetSkillValue(Focus);
                case SkillName.Forensics:
                    return GetSkillValue(Forensic);
                case SkillName.Healing:
                    return GetSkillValue(Healing);
                case SkillName.Herding:
                    return GetSkillValue(Herding);
                case SkillName.Hiding:
                    return GetSkillValue(Hiding);
                case SkillName.Imbuing:
                    return GetSkillValue(Imbuing);
                case SkillName.Inscribe:
                    return GetSkillValue(Inscription);
                case SkillName.ItemID:
                    return GetSkillValue(ItemIdentification);
                case SkillName.Lockpicking:
                    return GetSkillValue(Lockpicking);
                case SkillName.Lumberjacking:
                    return GetSkillValue(Lumberjacking);
                case SkillName.Macing:
                    return GetSkillValue(MaceFighting);
                case SkillName.Magery:
                    return GetSkillValue(Magery);
                case SkillName.MagicResist:
                    return GetSkillValue(ResistingSpells);
                case SkillName.Meditation:
                    return GetSkillValue(Meditation);
                case SkillName.Mining:
                    return GetSkillValue(Mining);
                case SkillName.Musicianship:
                    return GetSkillValue(Musicianship);
                case SkillName.Mysticism:
                    return GetSkillValue(Mysticism);
                case SkillName.Necromancy:
                    return GetSkillValue(Necromancy);
                case SkillName.Ninjitsu:
                    return GetSkillValue(Ninjitsu);
                case SkillName.RemoveTrap:
                    return GetSkillValue(RemoveTrap);
                case SkillName.Stealth:
                    return GetSkillValue(StealthSkill);
                case SkillName.Snooping:
                    return GetSkillValue(Snooping);
                case SkillName.Spellweaving:
                    return GetSkillValue(Spellweaving);
                case SkillName.SpiritSpeak:
                    return GetSkillValue(SpiritSpeak);
                case SkillName.Stealing:
                    return GetSkillValue(Stealing);
                case SkillName.Swords:
                    return GetSkillValue(Swordsmanship);
                case SkillName.Tactics:
                    return GetSkillValue(Tactics);
                case SkillName.Tailoring:
                    return GetSkillValue(Tailoring);
                case SkillName.TasteID:
                    return GetSkillValue(TasteIdentification);
                case SkillName.Throwing:
                    return GetSkillValue(Throwing);
                case SkillName.Tinkering:
                    return GetSkillValue(Tinkering);
                case SkillName.Tracking:
                    return GetSkillValue(Tracking);
                case SkillName.Veterinary:
                    return GetSkillValue(Veterinary);
                case SkillName.Wrestling:
                    return GetSkillValue(Wrestling);
            }
            return 0.0;
        }
        #endregion
        ...
        public bool DragItem(uint itemId, int count)
        {
            ...
            _client.SendPacket(PacketType.SCDragItem, itemId, count);
            return true;
        }
        ...
        {
            return await Task.Run(()=> { return CheckLag(timeOutMS); });
        }
        ...
        public Array GetPathArrayEnumerable(ushort destX, ushort destY, bool optimized, int accuracy)
        {
            return _client.SendPacket<Array>(PacketType.SCGetPathArray, destX, destY, optimized, accuracy);
        }
        //TODO: Needs testing
